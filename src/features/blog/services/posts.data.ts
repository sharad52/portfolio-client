/**
 * ─────────────────────────────────────────────────────────────────────────
 *  BLOG POSTS — single source of truth for article data.
 *
 *  Kept dependency-free (only a type-only import) on purpose: the build-time
 *  prerender in scripts/prerender.mjs imports this file directly under Node's
 *  native TypeScript support to bake per-article Open Graph tags into static
 *  HTML. Don't add runtime imports here or that step will break.
 * ─────────────────────────────────────────────────────────────────────────
 */
